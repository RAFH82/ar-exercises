...
@store1.employees.create(first_name: "Ryan", last_name: "Hrechka", hourly_rate: 30)
...
@store2.employees.create(first_name: "Lance", last_name: "Stroll", hourly_rate: 30)
...
@store4.employees.create(first_name: "Lewis", last_name: "Hamilton", hourly_rate: 30)
